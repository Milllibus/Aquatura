...
ActiveRecord::Schema.define(version: 2021_08_26_094300) do
  ...
  create_table "eplants", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_eplants_on_user_id"
  end
  ...
  create_table "plants", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.date "waterings_date", array: true
  ...
  create_table "species", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.text "description"
    t.string "image_url", default: "https://www.monrovia.com/media/catalog/product/cache/e5452c18e1c4fefc7252403522e22bd5/r/e/rest_1_1_11601.jpeg"
  end
